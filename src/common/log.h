...
const std::string ANSI_TEXT_COLOR_WHITE_BRIGHT = "\u001b[97;1m";
...
const std::string CONSOLE_COLOR_BKGRND_YELLOW_RED = "\u001b[33;31;1m";
const std::string CONSOLE_COLOR_BKGRND_MAGENTA_WHITE = "\u001b[35;97;1m";
...
void __cdecl ErrorDescFunc(const char* pChannel, const char* pFormat, ...);
...
# define COUTDBG( ... )  { ConsoleDebug(CONSOLE_COLOR_YELLOW,  __VA_ARGS__ );  }	

# define COUTRS( ... )  { ConsoleVerboseOut(CONSOLE_COLOR_RED,  __VA_ARGS__ );  }	
# define COUTR( ... )   { ConsoleVerboseOut(CONSOLE_COLOR_RED_BRIGHT,  __VA_ARGS__ );  }	
# define COUTY( ... )   { ConsoleVerboseOut(CONSOLE_COLOR_YELLOW,  __VA_ARGS__ );  }	
# define COUTYS( ... )   { ConsoleVerboseOut(CONSOLE_COLOR_YELLOW_BRIGHT,  __VA_ARGS__ );  }	
# define COUTCS( ... )  { ConsoleVerboseOut(CONSOLE_COLOR_CYAN,  __VA_ARGS__ );  }
# define COUTC( ... )   { ConsoleVerboseOut(CONSOLE_COLOR_CYAN_BRIGHT,  __VA_ARGS__ );  }	
...
# define LOG_DEBUG(c,fmt, ... ) { DebugTraceFunc(c,fmt ,  __VA_ARGS__ ); }
# define ERROR_DESC(c,fmt, ... ) { ErrorDescFunc(c,fmt ,  __VA_ARGS__ ); }
# define COUTMS( ... )   { ConsoleVerboseOut(CONSOLE_COLOR_MAGENTA_BRIGHT,  __VA_ARGS__ );  }	
# define COUTM( ... )   { ConsoleVerboseOut(CONSOLE_COLOR_MAGENTA,  __VA_ARGS__ );  }	

# define COUTBB( ... )  { ConsoleVerboseOut(ANSI_TEXT_COLOR_BLACK,  __VA_ARGS__ );  }	
